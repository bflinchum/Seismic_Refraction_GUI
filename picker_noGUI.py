...
class picker:
    def __init__(self):
        ...
        # path = '/Users/bflinch/Dropbox/Clemson/Research/Manuscripts/S-waveVelocites/Version3-siteComparison/Figures/RawData/'
        # np.savetxt(path+'SCP_Shot_'+str(shotLoc)+'.txt',np.column_stack([xwrite,twrite,dwrite]),fmt='%10.4f')
        # # = np.repeat(x,len(t))
