...
class seismicData:   
    ...
    def __init__(self):        
        #Pick file information
        self.path2PickFile = ''
        self.pickFile = '' #pick file name
        self.pickFileExists = False
        
        #Information about segy files
        self.path2SegyData = ''
        self.segyFilesInDirectory = []
        self.shotLocations = np.array([],dtype=float)
...
class plottingSeismicDataParameters():
    def __init__(self):        
        ...
        self.shotWin_colorMap = 'gray' #colormap for pcolorfast
